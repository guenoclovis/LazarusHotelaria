...
public class ReservaFacade {
    ...
    public ResponseDTO persistir(ReservaDTO dto) {
        String logMsg = "Iniciando a persistÃªncia de reserva";
        log.info(logMsg);
	...
	private Integer obterIDCliente(ReservaDTO dto, Cliente c) {
        ...
        if(cliente == null){
        	...
        	logMsg = "Realizou PrÃ©-Cadastro de UsuÃ¡rio";
	...
	private void enviarEmail(ReservaDTO dto, Reserva reserva, String checkoutCode) {
        ...
        mensagem.append("<br>Código para Pagamento no PagSeguro:  "+checkoutCode);
        mensagem.append("<br>");
