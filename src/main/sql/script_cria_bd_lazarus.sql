...
CREATE TABLE RESERVA(
	...
	STATUS			INTEGER		NOT NULL	DEFAULT 1, -- 1 SOLICITADA; 2 CONFIRMADA 3 CHECKIN 4 CHECKOUT 0 CANCELADA
...
SELECT setval('reserva_cod_reserva_seq', COALESCE((SELECT MAX(cod_reserva)+1 FROM reserva), 1), false);
);
